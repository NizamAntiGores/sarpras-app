                ...
                <div class="p-6">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Nama Lokasi
                                </th>
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Keterangan
                                </th>
                                <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">Jumlah
                                    Unit</th>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        <a href="{{ route('sarpras.index', ['lokasi_id' => $lok->id]) }}"
                                            class="inline-block hover:opacity-75 transition">
                                            <span
                                                class="px-2 py-1 text-xs rounded-full {{ $lok->units_count > 0 ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-600' }}">
                                                {{ $lok->units_count }} unit
                                                <svg class="w-3 h-3 inline ml-0.5 -mt-0.5" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        <div class="flex items-center justify-center space-x-2">
                                            ...
                                            <form action="{{ route('lokasi.destroy', $lok) }}" method="POST" class="inline"
