<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Lokasi Baru</h2>
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:p-8">
                    ...
                    <form action="{{ route('lokasi.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            <label for="nama_lokasi" class="block text-sm font-medium text-gray-700 mb-1">Nama Lokasi
                                <span class="text-red-500">*</span></label>
                            <input type="text" name="nama_lokasi" id="nama_lokasi" value="{{ old('nama_lokasi') }}"
                                placeholder="Ruang Lab TKJ"
                        ...
                        <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
                            <a href="{{ route('lokasi.index') }}"
                                class="px-4 py-2 bg-white border border-gray-300 rounded-lg text-xs font-semibold text-gray-700 uppercase hover:bg-gray-50">Batal</a>
                            <button type="submit"
                                class="px-4 py-2 bg-blue-600 rounded-lg text-xs font-semibold text-white uppercase hover:bg-blue-700">
