                ...
                <div class="p-6">
                    <div class="flex flex-col md:flex-row gap-4 justify-end items-center mb-6">
                        <form method="GET" class="flex flex-wrap gap-2 w-full md:w-auto">
                            ...
                            @endif
                            <a href="{{ route('export.sarpras.units', array_merge(['sarpras' => $sarpras->id], request()->query())) }}"
                                class="px-3 py-2 bg-red-600 text-white rounded-lg text-sm hover:bg-red-700 inline-flex items-center gap-1">
