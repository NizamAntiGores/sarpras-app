        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="mt-3 sm:mt-0 flex space-x-2">
                ...
                @if ($maintenance->status === 'sedang_berlangsung')
                    <a href="{{ route('maintenance.edit', $maintenance) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg text-xs font-semibold uppercase hover:bg-blue-700">
