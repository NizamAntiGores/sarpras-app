                            ...
                            <div class="bg-red-50 border-l-4 border-red-500 p-4 rounded-r-lg">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3 w-full">
                                        <h3 class="text-red-800 font-semibold mb-2">🚨 Stok Habis ({{ $data['stokHabis']->count() }} barang)</h3>
                                        <ul class="space-y-2">
                        ...
                        @if (($data['stokMenipis'] ?? collect())->count() > 0)
                            <div class="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-r-lg">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3 w-full">
                                        <h3 class="text-yellow-800 font-semibold mb-2">⚠️ Stok Menipis ({{ $data['stokMenipis']->count() }} barang)</h3>
                                        <ul class="space-y-2">
