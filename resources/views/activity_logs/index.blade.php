                        ...
                        <form method="GET" class="flex flex-wrap gap-3 items-end">
                            ...
                            <div class="flex gap-2">
                                ...
                                @if(request()->hasAny(['search', 'action', 'user_id', 'date_from', 'date_to']))
                                    <a href="{{ route('activity-logs.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg text-sm hover:bg-gray-300 transition">
                                        Reset
                                    </a>
                                @endif
                                <a href="{{ route('export.activity-logs', request()->query()) }}" 
                                   class="px-4 py-2 bg-red-600 text-white rounded-lg text-sm hover:bg-red-700 transition inline-flex items-center gap-1">
