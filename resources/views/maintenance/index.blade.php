<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="{{ route('maintenance.create') }}" class="mt-3 sm:mt-0 inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg text-xs font-semibold uppercase hover:bg-blue-700">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm rounded-lg mb-6 p-4">
                <form method="GET" class="flex flex-wrap gap-4 items-end">
                    ...
                    <a href="{{ route('export.maintenance', request()->query()) }}" 
                       class="px-4 py-2 bg-red-600 text-white rounded-md text-sm hover:bg-red-700 inline-flex items-center gap-1">
                                        ...
                                        <td class="px-4 py-4 text-center">
                                            <div class="flex items-center justify-center space-x-2">
                                                ...
                                                @if ($maintenance->status === 'sedang_berlangsung')
                                                    <a href="{{ route('maintenance.edit', $maintenance) }}" class="text-blue-600 hover:text-blue-900" title="Edit">
